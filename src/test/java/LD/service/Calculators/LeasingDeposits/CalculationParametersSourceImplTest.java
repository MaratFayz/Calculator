...
//
//    static CalculationParametersSourceImpl GDK = new CalculationParametersSourceImpl();
//    @Mock
...
//            GDK.prepareParameters(scenarioSource, scenarioDestination);
//        });
//
...
//
//        Throwable thrown = assertThrows(IllegalArgumentException.class, () -> {
//            GDK.prepareParameters(copyDate, scenarioSource, scenarioDestination);
//        });
//
...
//            CalculationParametersSourceImpl gdk = new CalculationParametersSourceImpl();
//            gdk.prepareParameters(null, 1L, 2L);
//        });
//
