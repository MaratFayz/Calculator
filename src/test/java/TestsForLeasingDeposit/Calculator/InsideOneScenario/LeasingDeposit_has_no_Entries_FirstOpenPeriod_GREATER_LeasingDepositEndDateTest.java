...
public class LeasingDeposit_has_no_Entries_FirstOpenPeriod_GREATER_LeasingDepositEndDateTest {
    ...
    public void setUp() throws ExecutionException, InterruptedException {
        ...
        Mockito.when(GDK.getFirstOpenPeriod_ScenarioFrom()).thenReturn(Builders.getDate(31, 3, 2020));
    ...
    public void test6_Reg_LD_1() {
        ...
        //30.09.2019
        var LD1_30092019 = lec.getCalculatedStornoDeletedEntries().stream()
        ...
        //31.10.2019
        var LD1_31102019 = lec.getCalculatedStornoDeletedEntries().stream()
        ...
        //30.11.2019
        var LD1_30112019 = lec.getCalculatedStornoDeletedEntries().stream()
                .filter(tr -> tr.getEntryID().getPeriod().getDate().isEqual(Builders.getDate(30, 11, 2019).withZoneSameInstant(ZoneId.of("Europe/Moscow"))))
                .filter(tr -> tr.getEntryID().getScenario().getName().equals("FACT"))
                .filter(tr -> tr.getStatus().equals(EntryStatus.ACTUAL))
                .collect(Collectors.toList()).get(0);
    ...
    public void test8_Reg_LD_3() {
        ...
        assertEquals(LeasingDepositDuration.ST, LD1_30092019.getLDTERM_REG_LD_3_Z());
        ...
        assertEquals(LeasingDepositDuration.ST, LD1_30112019.getLDTERM_REG_LD_3_Z());
