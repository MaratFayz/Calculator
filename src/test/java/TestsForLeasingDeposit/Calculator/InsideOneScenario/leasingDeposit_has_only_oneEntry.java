...
/*		//31.03.2017
		var LD1_31032017 = lec.getCalculatedStornoDeletedEntries().stream()
				.filter(tr -> tr.getEntryID().getPeriod().getDate().isEqual(getDate(31, 3, 2017).withZoneSameInstant(ZoneId.of("Europe/Moscow"))))
...
/*		//31.03.2017
    ...
    public static void create_LD_1_NormalTestLD() {
        ...
        Entry entry = Entry.builder()
                .entryID(entryID)
                .end_date_at_this_period(Builders.getDate(20, 10, 2019))
